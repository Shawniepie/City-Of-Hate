...
NGame = {
	...
	FUEL_RESOURCE = "food",							 -- resource that will give country fuel, changed to food for the mod
	...
	HANDS_OFF_START_TAG = "SUL",					-- tag for player country for -hands_off runs. use an existing tag that is less likely to affect the game
},
...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_START_DATE = "887.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
	...
	ASSUME_FACTION_LEADERSHIP_COOLDOWN_DAYS = 999999,			-- Number of days after formation of faction or change in leadership before another country is allowed to assume leadership.
	ASSUME_FACTION_SPYMASTER_COOLDOWN_DAYS = 999999,			-- Number of days after change of Spy Master before another country is allowed to become Spy Master.
...
NCountry = {
	...
	RESISTANCE_STRENGTH_FROM_VP = 0.002,			-- How much strength ticking speed gives each VP score.
	RESISTANCE_STRENGTH_FROM_NEIGHBORS = 0.6, 		-- Multiplies how much resistance can spread from one state to its neighbors, a state will spread whatever is highest of its victorypoints resistance increase or half of any of its neighbors spread, multiplied by this
...
NResistance = {
	INITIAL_STATE_RESISTANCE = 5.0,							-- initial resistance percentage of a state once it is captured
	...
	RESISTANCE_TARGET_BASE = 55.0,							-- base resistance target percentage
	
	RESISTANCE_TARGET_MODIFIER_HAS_CLAIM = -50.0,			-- resistance target modifier in % for states we have claim

	RESISTANCE_TARGET_MODIFIER_PER_STABILITY_LOSS = 0.3,	-- resistance target modifier per stability below 100%
	RESISTANCE_TARGET_MODIFIER_PER_COMPLIANCE = -0.5,		-- resistance target modifier per compliance %
	
	RESISTANCE_TARGET_MODIFIER_IS_AT_PEACE = -15.0,			-- resistance target modifier when we are at peace
	...
	GARRISON_MANPOWER_LOST_BY_ATTACK = 0.3, 	-- Ratio of manpower lost by garrison at each attack on garrison (this number will be reduced by the hardness of garrison template)
