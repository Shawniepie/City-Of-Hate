...
NAI = {
	...
	DIPLOMACY_FACTION_WRONG_IDEOLOGY_PENALTY = 1.25, -- AI penalty for diplomatic faction acitons between nations of different ideologies
	...
	DIPLOMACY_FACTION_NEUTRALITY_PENALTY = 1.25,	-- Neutral nations have a separate penalty, not wanting to get involved at all, rather than caring much about the difference in ideology
	...
	DIPLOMACY_LEAVE_FACTION_OPINION_FACTOR = 2.5,-- How much the opinion of countries being targeted by faction leader matters when deciding to leave a faction (democratic only)
